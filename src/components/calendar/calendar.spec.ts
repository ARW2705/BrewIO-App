...
describe('Calendar Component', () => {
  ...
  test('should create the component', () => {
    ...
    expect(calendar instanceof CalendarComponent).toBe(true);
  ...
  test('should return final data to parent component', () => {
    ...
    expect(returnData.alerts[0].datetime).toMatch(now.clone().add(_mockCalendarStep.duration, 'days').toISOString());
  ...
  test('should check if given date is a projected date', () => {
    ...
    expect(calendar.isProjected(now.clone().add(mockCalendarStep().duration, 'days'))).toBe(true);
